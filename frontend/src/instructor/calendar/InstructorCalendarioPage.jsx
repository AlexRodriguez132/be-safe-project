...
import './css/InstructorCalendarioPage.css'
export default function InstructorCalendarioPage(){
    useEffect(() => {
        const calendarEl = document.getElementById('calendar-dom');
