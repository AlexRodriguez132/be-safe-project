      ...
      <div className="detalle-card">
        ...
        <div className="detalle-desc">
          {editandoDesc ? (
            ...
            <div className="desc-view" onClick={() => setEditandoDesc(true)} style={{ cursor: 'text' }}>
              <p>{curso.descripcion || <span style={{ color: '#9ca3af' }}>Haz clic para agregar descripción...</span>}</p>
            </div>
          )}
        </div>
      </div>
