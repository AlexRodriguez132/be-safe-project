...
const IconDollar = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 6v12M9 9.5a3 3 0 0 1 6 0c0 1.5-1 2.5-3 3s-3 1.5-3 3a3 3 0 0 0 6 0"/></svg>
);
const IconUsers = () => (
...
const NAV = [
  ...
  { to: '/clases-en-vivo', label: 'Clases en vivo', Icon: IconMonitor },
  { to: '/asesorias', label: 'Asesorías', Icon: IconChat },
];
  ...
  return (
    <div className="user-layout">
      <aside className="user-sidebar">
        <div className="user-sidebar__logo">BE SAFE</div>
        <nav className="user-sidebar__nav">
          {NAV.map(({ to, label, Icon, end }) => (
            ...
            >
              <span className="user-nav-link__icon"><Icon /></span>
              {label}
            </NavLink>
          ))}
        </nav>
        <NavLink to="/configuracion" className="user-nav-link user-nav-link--bottom">
          <span className="user-nav-link__icon"><IconSettings /></span> Configuración
        </NavLink>
      </aside>
      ...
      <div className="user-content">
        <header className="user-topbar">
          ...
          <div className="user-topbar__actions">
            ...
            <button className="topbar-btn topbar-btn--avatar" title="Perfil">
